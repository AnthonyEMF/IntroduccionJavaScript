...
function agregarCurso(e){
    e.preventDefault(); // No se refrescara la pagina
    if(e.target.classList.contains('agregar-carrito')){ // Especifica que sea le boton
...
function limpiarHTML(){
    // Forma mas facil (afecta el rendimiento)
